 ...
 * OSC.
 *
 * Created by calls to lop_bundle_new(), messages can be added with calls to
 * lop_bundle_add_message().
 */
typedef void *lop_bundle;
 ...
 *
 * Created by calls to lop_server_thread_new().
 */
typedef void *lop_server_thread;
